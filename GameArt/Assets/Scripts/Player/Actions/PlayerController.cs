...
public class PlayerController : MonoBehaviour {
    ...
    {
        GameObject.Find("Camera").GetComponent<CameraFollow>().updateState();
        //if (camera_boss.GetComponent<CameraFollow>().state == "default")
        //camera_boss.GetComponent<CameraFollow>().state = "state1";
    ...
    void Flip()
    {
        ...
        GameObject.Find("Camera").GetComponent<CameraFollow>().FlipCamera();
    }
